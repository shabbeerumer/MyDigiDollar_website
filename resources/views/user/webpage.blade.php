...
<body>
    ...
    <a class="nav-link active" href="#" style=" font-size: 15px;">Home</a>
</li>
                    ...
                    <div class="text-bg p-4" style="border-radius: 20px;">
                        <div class="welcome d-flex flex-column justify-content-center h-100">
                            ...
                            <div class="text-center mt-auto">
                                <a href="register.html"> <button class="btn btn-success">Get Started</button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-6 col-md-12" data-aos="fade-right">
                    <div class="Works">
                        ...
                        <p class="text-center">Simple Steps to Start Earning: Choose a subscription plan that suits your
                            goals. Activate
